...
class UserPreferences(Base):
    ...
    max_price: Mapped[float] = mapped_column(Float, default=30.0)
    max_float: Mapped[float] = mapped_column(Float, default=20000000.0)
    max_market_cap: Mapped[float] = mapped_column(Float, default=3000000000.0)
    min_rvol: Mapped[float] = mapped_column(Float, default=1.5)
    min_volume: Mapped[int] = mapped_column(Integer, default=50000)
