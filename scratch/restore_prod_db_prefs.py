...
async def main():
    print("Connecting to database to restore production preferences and clear test signals...")
    async with async_session() as db:
        ...
        # 2. Clear CMCL Test Signals from DB
        print("Cleaning up CMCL test signals...")
        await db.execute(
