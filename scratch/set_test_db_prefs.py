...
async def main():
    print(f"Connecting to database to update preferences for admin ID: {settings.ADMIN_TELEGRAM_ID}")
    async with async_session() as db:
        ...
        print("Updating to test values: min_rvol=0.5, min_score_threshold=1.5")
        pref.min_rvol = 0.5
        pref.min_score_threshold = 1.5
